  ...
  return (
    <header className="h-14 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4">
      <div className="flex items-center gap-6">
        <h1 className="text-xl font-bold text-gray-800 dark:text-white">🐉 DragonBricks</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-800 dark:bg-gray-600 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
      ...
      {showSettings && (
        <>
          ...
          />
          <div className="absolute top-14 right-4 z-50 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-72 p-4">
            <h3 className="font-semibold text-gray-800 dark:text-white mb-3">Settings</h3>
            <div className="space-y-3 text-sm">
              <div>
                <label className="block text-gray-600 dark:text-gray-300 mb-1">Default Speed (mm/s)</label>
                <input
                  type="number"
                  defaultValue={200}
              ...
              <div>
                <label className="block text-gray-600 dark:text-gray-300 mb-1">Default Turn Rate (deg/s)</label>
                <input
                  type="number"
                  defaultValue={150}
                  className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 dark:text-white"
              ...
              <div>
                <label className="block text-gray-600 dark:text-gray-300 mb-1">Wheel Diameter (mm)</label>
                <input
                  type="number"
                  defaultValue={56}
                  className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 dark:text-white"
              ...
              <div>
                <label className="block text-gray-600 dark:text-gray-300 mb-1">Axle Track (mm)</label>
                <input
                  type="number"
                  defaultValue={112}
                  className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 dark:text-white"
